...
<body>
    <h2>แก้ไขมูลลูกค้าเข้าฐานข้อมูล1<h2>
            <form action="udcdatebase.php" method="POST">
                <form>
                    ...
                    <select name="CountryCode" id="CountryCode">
                        ...
                        foreach ($cc as $c) {
                            if ($selected == $c['CountryName']) {
                                ...
                                echo '<option selected value="' . ["CountryCode"]  . '">' .  $result_customer["CountryName"] . '</option>';
                            } else {
                                echo '<option value="' . ["CountryCode"] . '">' .  $c["CountryName"] . '</option>';
                            }
                        }
                        ?>
